...
// Time complexity: O(165*2^30) precalculation, O(165) per move
// Memory: O(2^30)

// @EXPECTED_RESULTS@: TIMELIMIT

// Solution method: precalculate all losing states using DP (takes a lot of time)
...
int main()
{ int cases, casenr, state, m = 0, s, i, r, c, r1, c1, r2, c2;
  char t;
  ...
  /* // Shortcut (to use instead of the above)
  FILE* in = fopen("precalc.in", "r");
  fread(Losing, 1, S>>3, in);
  fclose(in);//*/
