// @EXPECTED_RESULTS@: CORRECT
    ...
    int main(){ 
      int NumberOfCases;
      long long value_M, temp_value_M, value_Z, temp_value_Z;
      long long suffix_M, suffix_Z, powers;
	...
	powers=10;
	for (i = 1; i <= r-1; i++) {
          suffix_M = (long long)( value_M % powers);
	  S[i] = (suffix_M + 1);
          powers=powers*10;
	}
	suffix_M = (long long)( value_M % powers);
	suffix_Z = (long long)( value_Z % powers);
