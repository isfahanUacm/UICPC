...
void solve(short node, short k)
{
	...
	if (force_edge[node] != -1 && force_edge[force_edge[node]] == -1 && force_edge[force_edge[node]] != 0) res.insert(force_edge[node]);
	...
	if (force_edge[node] != -1 && force_edge[force_edge[node]] != -1 && force_edge[force_edge[node]] != 0) solve(force_edge[node], k);
}
