...
int main()
{
    ...
    for(int i = 0 ; i < t; i++)
    {
        if((u[i] == "A" || u[i] == "B" || u[i] == "C") && (v[i] == "A" || v[i] == "B" || v[i] == "C"))
            cout << "NO" << endl;
        else if((u[i] == "AA" || u[i] == "BB" || u[i] == "CC" || u[i] == "ABAB" || u[i] == "BCBC" || u[i]=="ABACBC") && (v[i] == "AA" || v[i] == "BB" || v[i] == "CC" || v[i] == "ABAB" || v[i] == "BCBC" || v[i] == "ABACBC"))
            cout << "YES" << endl;
...
void func1(string & u , string v)
{
    for(int i = 0 ; i < u.length() ; i++)
    {
        ...
        else if(u[i] == 'A' && u[i + 1] == 'B' && u[i + 2] == 'A' && u[i + 3] == 'C' && u[i + 4] == 'B' && u[i + 5] == 'C')
        {
            remove(u , 6 , i);
            func1(u , v);
        }
...
bool func2(string &v , string &u)
{
    for(int i = 0 ; i < v.length() ; i++)
    {
        ...
        if(v[i] == 'A' && v[i + 1] == 'B' && v[i + 2] == 'A' && v[i + 3] == 'C' && v[i + 4] == 'B' && v[i + 5] == 'C')
        {
            remove(v , 6 , i);
            func3(v , u);
        }
...
bool func3(string &v , string &u)
{
    for(int i = 0 ; i < v.length() ; i++)
    {
        ...
        else if(v[i] == 'A' && v[i + 1] == 'B' && v[i + 2] == 'A' && v[i + 3] == 'C' && v[i + 4] == 'B' && v[i + 5] == 'C')
        {
            remove(v , 6 , i);
            func3(v , u);
        }
...
void remove(string &u , int Rlen , int index)
{
    ...
    else if (Rlen == 6)
    {
        for(int i = 0; i < u.length(); i++)
        {
            if(i != index && i != index + 1 && i != index + 2 && i != index + 3 && i != index + 4 && i != index + 5)
            {
                tmp += u[i];
